...
VALUES (100, 'Тест 1', 'Страна 1, Страна 2', '2022-01-01', 'SIXTEEN_PLUS', 'PARENTS_STRONGLY_CAUTIONED', 120, 'Описание 1', 'MOVIE'),
       ...
       (104, 'Тест 5', 'Страна 9, Страна 10', '2022-05-05', 'SIXTEEN_PLUS', 'PARENTAL_GUIDANCE_SUGGESTED', 130, 'Описание 5', 'SERIAL'),
       (105, 'Тест 6', 'Страна 11, Страна 12', '2022-05-05', 'SIXTEEN_PLUS', 'GENERAL_AUDIENCES', 130, 'Описание 6', 'CARTOON');
